...
1. **Install Required Tools:**
   - **gog** (Google CLI): https://github.com/sashabaranov/gogcli
   - **Atlassian MCP**: Configure through your MCP server registry  
   - **Slack MCP**: Configure through your MCP server registry
